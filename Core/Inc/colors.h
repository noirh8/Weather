...
// Color
#define COLOR_BackGround_1					(uint16_t)(0x755b)
#define COLOR_BackGround_2 					(uint16_t)(0x85fc)
#define COLOR_BackGround_3					(uint16_t)(0x9ed8)
#define COLOR_morningBot  					(uint16_t)(0x9c7c)		//#9A8CE4
#define COLOR_noonBot  						(uint16_t)(0x6ede)		//#6AD8F1
#define COLOR_eveningBot  					(uint16_t)(0xfcab)		//#FC935A
#define COLOR_nightBot  					(uint16_t)(0x308b)		//#341362
// Color Palettes
